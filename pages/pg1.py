...
dash.register_page(__name__,
                   ...
                   name='Porcentaje de mujeres que han experimentado violencia psicologica por parte de su pareja',  # name of page, commonly used as name of link
                   title='Porcentaje de mujeres que han experimentado violencia psicologica por parte de su pareja'  # epresents the title of browser's tab
)
...
layout = html.Div([
        ...
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in list_comparacion_por_ordenada], multi=False, persistence=True, persistence_type='memory', value='Mujeres', id='page1-comparacion_por_elect')
        ], width=6),
    ]),
        dbc.Row([
        dbc.Col([
